      ...
      <div className={`absolute inset-0 top-[100px] max-w-7xl !mx-auto !sm:px-16 !px-6 flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`text-[#dfd9ff] font-medium lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px] mt-2 text-white-100`}>
            I am a Full-Stack MERN Developer <br className='sm:block hidden' />
            building scalable Web Applications
          </p>
        </div>
      </div>

      <div className="sm:w-full w-[450px] h-[450px] sm:h-screen translate-y-24 transform sm:translate-y-0">
        <ComputersCanvas />
      </div>
